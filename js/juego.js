...
var instrucciones = ["¿Podés ayudar a BMO a mirarse al espejo?", "Mové las piezas usando las flechas del teclado", "La imagen debe quedar como esta:"];
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  ...
  grillaTemp[filaPos1][columnaPos1] = grilla[filaPos1][columnaPos1] 
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = grillaTemp[filaPos1][columnaPos1];
}
